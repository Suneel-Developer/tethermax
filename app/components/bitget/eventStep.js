...
const EventStep = () => {
  ...
  return (
    <section className='pt-7 md:pt-8 bg-white'>
      <div className='mx-5 f-pretendard-b text-gray_900 text-[22px] leading-[32px]'>현재 진행중인 Bitget 이벤트에요</div>
      ...
      <div className='mt-8 flex gap-4 px-5 overflow-x-auto no-scrollbar pb-14'>
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_bitget-competition.webp" alt="_bybit" className='rounded-2xl' width={155} height={155} loading='lazy' />
        ...
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_bitget-event.webp" alt="_bybit" className='rounded-2xl' width={155} height={155} loading='lazy' />
          <div className='mt-1 flex flex-col gap-1'>
            <p className='text-gray_500 text-[13px] leading-[20px] f-pretendard-m'>딥코인 신규회원 이벤트</p>
            <p className='text-gray_900 text-[17px] leading-[26px] f-pretendard-b'>입금하고 최대 1,000 USDT 받아가세요!</p>
            <div className='flex items-center gap-2'>
      ...
      <div className='text-gray_900 text-[22px] f-pretendard-b px-5 leading-[32px]'>Bitget와 함께한 이벤트들</div>

      <div className='mt-8 flex gap-4 px-5 overflow-x-auto no-scrollbar pb-14'>

        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_bitget-competition.webp" alt="_deepcoin" className='rounded-2xl' width={155} height={155}loading='lazy' />
          <div className='mt-1 flex flex-col gap-1'>
            <p className='text-gray_500 text-[13px] leading-[20px] f-pretendard-m'>딥코인 신규회원 이벤트</p>
            <p className='text-gray_900 text-[17px] leading-[26px] f-pretendard-b'>입금하고 최대 1,000 USDT 받아가세요!</p>
            <div className='flex items-center gap-2'>
        ...
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_bitget-event.webp" alt="_deepcoin" className='rounded-2xl' width={155} height={155} loading='lazy' />
          <div className='mt-1 flex flex-col gap-1'>
            <p className='text-gray_500 text-[13px] leading-[20px] f-pretendard-m'>딥코인 신규회원 이벤트</p>
            <p className='text-gray_900 text-[17px] leading-[26px] f-pretendard-b'>입금하고 최대 1,000 USDT 받아가세요!</p>
            <div className='flex items-center gap-2'>
      ...
      <div className='bg-gray_55 pt-8 pb-[150px] px-5'>
        ...
        <p className="text-gray_300 text-[13px] mt-3 f-pretendard-sm" style={{ lineHeight: "150%" }}>
          Bitget과 테더맥스는 공식 제휴계약 관계 입니다.<br />
          카피트레이딩 또는 API를 통해 거래하는 경우에는 45%의 페이백율이 적용됩니다.<br />
          테더맥스 계정으로 거래하는 수수료는 거래소의 최대 수수료에 50% 할인율을 적용한 수수료입니다. 54.5% 페이백은 매일 11:00 UTC시에 트레이더님의 테더맥스 계정으로 지급됩니다.<br />
          누적된 페이백의 보장 기간은 안전한 정보보호를 위해 최대 탈퇴할 때까지 보관됩니다. 거래소에서 지급하는 증정금 및 보너스는 유효한 리워드으로 잡히지 않으며, 증점금 및 보너스를 사용하기 전까지는 페이백이 뤄지지 않습니다.<br />
          거래소별로 마감 인원이 정해져 있어 마감 이후에는 해당 거래소의 페이백 서비스 이용이 어려울 수 있습니다.
