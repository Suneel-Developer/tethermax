...
const Hero = () => {
    ...
    return (
        <section>
            <div className='bg-[#2a54ff] min-h-[200px] flex flex-col justify-center items-center w-full'>
                <img src="/assets/binx-thumbnail.webp" alt="binx" className='w-[200px] h-[200px]' />
            </div>

            <div className='pt-6 pb-12 px-6 bg-white'>
                <p className='text-gray_900 text-[26px] f-pretendard-b'>BingX</p>
