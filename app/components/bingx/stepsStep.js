  ...
  return (
    <section>
      <div className='pt-8 md:pt-9 flex flex-col'>
        <p className='text-[22px] text-gray_900 mx-5 leading-[32px] f-pretendard-b'>BingX 페이백 받는 방법</p>
          ...
          <div className='mr-6 ml-[33px] mt-2 flex'>
            ...
            <button className='flex justify-between items-center flex-auto'>
              <div className='flex items-center'>
                <Image src="/assets/bingx.png" alt="BingX " className='rounded-full mr-[10px]' width={30} height={30} />
                <p className='text-[19px] text-blue_700 f-pretendard-b text-left'>BingX링크 (테더맥스 전용)</p>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className='mt-2'>
          <div className='px-5 flex items-center justify-center'>
            ...
            <p className='flex-1 text-gray_900 text-[17px] f-pretendard-b'>BingX에서 KYC 인증하고</p>
          </div>
          <div className='mr-6 ml-[33px] mt-2 flex'>
