  ...
  return (
    <section className='mt-8'>
      ...
      <div className='pt-8 md:pt-9'>
        <p className='text-[22px] text-gray_900 mx-5 leading-[32px] f-pretendard-b'>BitMEX 통계 데이터를 알아볼까요?</p>
        ...
        <div>
          ...
          <div className='mt-8'>
            <p className='text-gray_900 text-[22px] f-pretendard-b px-5 leading-[32px]'>BitMEX의 테더맥스 페이백 왕</p>
