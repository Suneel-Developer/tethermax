  ...
  return (
    <section>
      <div className='pt-8 md:pt-9 flex flex-col'>
        <p className='text-[22px] text-gray_900 mx-5 leading-[32px] f-pretendard-b'>OKX 페이백 받는 방법</p>
        ...
        <div className='mt-2'>
          <div className='px-5 flex items-center justify-center'>
            ...
            <p className='flex-1 text-gray_900 text-[17px] f-pretendard-b'>OKX에서 KYC 인증하고</p>
          </div>
          <div className='mr-6 ml-[33px] mt-2 flex'>
