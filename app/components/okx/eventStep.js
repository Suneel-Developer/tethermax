...
const EventStep = () => {
  ...
  return (
    <section className='pt-7 md:pt-8 bg-white'>
      <div className='mx-5 f-pretendard-b text-gray_900 text-[22px] leading-[32px]'>현재 진행중인 OKX 이벤트에요</div>
      ...
      <div className='mt-8 flex gap-4 px-5 overflow-x-auto no-scrollbar pb-14'>
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/okx-competition.webp" alt="_bybit" className='rounded-2xl' width={155} height={155} loading='lazy' />
      ...
      <div className='text-gray_900 text-[22px] f-pretendard-b px-5 leading-[32px]'>OKX와 함께한 이벤트들</div>
      ...
      <div className='bg-gray_55 pt-8 pb-[150px] px-5'>
        ...
        <p className="text-gray_300 text-[13px] mt-3 f-pretendard-sm" style={{ lineHeight: "150%" }}>
          OKX 트레이딩을 통한 페이백은 매일 11:00 UTC시에 트레이더님의 테더맥스 계정으로 지급됩니다.<br />
