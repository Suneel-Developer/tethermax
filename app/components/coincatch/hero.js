...
const Hero = () => {
    ...
    return (
        <section>
            <div className='bg-[#000000] min-h-[200px] flex flex-col justify-center items-center w-full'>
                <img src="/assets/coincatch-thumbnail.webp" alt="CoinCatch" className='w-[200px] h-[200px]' />
            </div>

            <div className='pt-6 pb-12 px-6 bg-white'>
                <p className='text-gray_900 text-[26px] f-pretendard-b'>CoinCatch</p>
