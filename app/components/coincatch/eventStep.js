...
const EventStep = () => {
  ...
  return (
    <section className='pt-7 md:pt-8 bg-white'>
      <div className='mx-5 f-pretendard-b text-gray_900 text-[22px] leading-[32px]'>현재 진행중인 CoinCatch 이벤트에요</div>
      ...
      <div className='mt-8 flex gap-4 px-5 overflow-x-auto no-scrollbar pb-14'>
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/coincatch_competition.webp" alt="CoinCatch" className='rounded-2xl' width={155} height={155} loading='lazy' />
      ...
      <div className='text-gray_900 text-[22px] f-pretendard-b px-5 leading-[32px]'>CoinCatch와 함께한 이벤트들</div>

      <div className='mt-8 flex gap-4 px-5 overflow-x-auto no-scrollbar pb-14'>

        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_coincatch-potion.webp" alt="CoinCatch" className='rounded-2xl' width={155} height={155} loading='lazy' />
          <div className='mt-1 flex flex-col gap-1'>
            <p className='text-gray_500 text-[13px] leading-[20px] f-pretendard-m'>딥코인 신규회원 이벤트</p>
            <p className='text-gray_900 text-[17px] leading-[26px] f-pretendard-b'>입금하고 최대 1,000 USDT 받아가세요!</p>
            <div className='flex items-center gap-2'>
      ...
      <div className='bg-gray_55 pt-8 pb-[150px] px-5'>
        ...
        <p className="text-gray_300 text-[13px] mt-3 f-pretendard-sm" style={{ lineHeight: "150%" }}>
          CoinCatch의 페이백은 매일 11시(UTC) 에 트레이더님의 테더맥스 계정으로 지급됩니다. <br />
          나의 페이백 랭킹 이벤트는 코인캐치의 경우 24년 04월 01일부터 최초 진행됩니다.<br />
          누적된 페이백의 보장 기간은 안전한 정보보호를 위해 최대 탈퇴할 때까지 보관됩니다. 거래소에서 지급하는 증정금 및 보너스는 유효한 리워드으로 잡히지 않으<br />
          며, 증점금 및 보너스를 사용하기 전까지는 페이백이 이뤄지지 않습니다.
          <br />
          ...
          CoinCatch의 경우, KYC가 되지 않은 계정에 대해선 페이백 출금이 진행되지 않습니다. <br />
