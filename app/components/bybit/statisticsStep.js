  ...
  return (
    <section className='mt-8'>
      ...
      <div className='pt-8 md:pt-9'>
        <p className='text-[22px] text-gray_900 mx-5 leading-[32px] f-pretendard-b'>Bybit  통계 데이터를 알아볼까요?</p>
        ...
        <div>
          ...
          <div className='mt-8'>
            <p className='text-gray_900 text-[22px] f-pretendard-b px-5 leading-[32px]'>Bybit의 테더맥스 페이백 왕</p>
            ...
            <div className='flex flex-col mt-7 mb-8 px-5 gap-[30px]'>
              <div className='flex justify-between items-center w-full'>
                <div className='flex items-center'>
                  ...
                  <div>
                    <p className='text-gray_400 text-[13px] f-pretendard-sm'>*****4367</p>
                    <p className='text-gray_900 text-[17px] f-pretendard-b'>160977.78 USDT</p>
                  </div>
                </div>
              ...
              <div className='flex justify-between items-center w-full'>
                <div className='flex items-center'>
                  ...
                  <div>
                    ...
                    <p className='text-gray_900 text-[17px] f-pretendard-b'>41459.26 USDT</p>
                  </div>
                </div>
                <img src="/assets/medal2.svg" alt="medal1" />
              </div>


              <div className='flex justify-between items-center w-full'>
                <div className='flex items-center'>
                  <img src="/assets/Tiger.webp" alt="Tiger" className='w-10 h-10 rounded-lg mr-4' />
                  <div>
                    <p className='text-gray_400 text-[13px] f-pretendard-sm'>*****8692</p>
                    <p className='text-gray_900 text-[17px] f-pretendard-b'>39754.8 USDT</p>
                  </div>
                </div>
                <img src="/assets/medal3.svg" alt="medal1" />
              </div>
