...
const Hero = () => {
    ...
    return (
        <section>
            <div className='bg-[#15192a] min-h-[200px] flex flex-col justify-center items-center w-full'>
                <img src="/assets/bybit-thumbnail.webp" alt="bybit" className='w-[200px] h-[200px]' />
            </div>

            <div className='pt-6 pb-12 px-6 bg-white'>
                <p className='text-gray_900 text-[26px] f-pretendard-b'>Bybit</p>
                <p className='text-gray_500 text-[17px] f-pretendard-sm mt-3'>수수료 페이백 <strong className='text-blue_700'>30%</strong></p>
                ...
                <div className='mt-8 flex-col flex gap-4'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <p className='mr-2 text-blue_700 text-[22px] f-pretendard-b'>0.0014%</p>
                    </div>
                    <div className='flex items-center'>
                        <p className='mr-[54px] text-gray_500 text-[17px] f-pretendard-b'>지정가</p>
                        <p className='mr-2 text-gray_300 text-lg f-pretendard-m line-through'>0.06%</p>
                        <p className='mr-2 text-blue_700 text-[22px] f-pretendard-b'>0.0308%</p>
                    </div>
