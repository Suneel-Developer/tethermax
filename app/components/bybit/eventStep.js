...
const EventStep = () => {
  ...
  return (
    <section className='pt-7 md:pt-8 bg-white'>
      <div className='mx-5 f-pretendard-b text-gray_900 text-[22px] leading-[32px]'>현재 진행중인 Bybit  이벤트에요</div>
      ...
      <div className='mt-8 flex gap-4 px-5 overflow-x-auto no-scrollbar pb-14'>
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_bybit_event.webp" alt="_bybit" className='rounded-2xl' width={155} height={155} loading='lazy' />
        ...
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/event1.webp" alt="_bybit" className='rounded-2xl' width={155} height={155} loading='lazy' />
          <div className='mt-1 flex flex-col gap-1'>
            <p className='text-gray_500 text-[13px] leading-[20px] f-pretendard-m'>딥코인 신규회원 이벤트</p>
            <p className='text-gray_900 text-[17px] leading-[26px] f-pretendard-b'>입금하고 최대 1,000 USDT 받아가세요!</p>
            <div className='flex items-center gap-2'>
      ...
      <div className='text-gray_900 text-[22px] f-pretendard-b px-5 leading-[32px]'>Bybit와 함께한 이벤트들</div>

      <div className='mt-8 flex gap-4 px-5 overflow-x-auto no-scrollbar pb-14'>

        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_bybit.webp" alt="_deepcoin" className='rounded-2xl' width={155} height={155} loading='lazy' />
          <div className='mt-1 flex flex-col gap-1'>
            <p className='text-gray_500 text-[13px] leading-[20px] f-pretendard-m'>딥코인 신규회원 이벤트</p>
            <p className='text-gray_900 text-[17px] leading-[26px] f-pretendard-b'>입금하고 최대 1,000 USDT 받아가세요!</p>
            <div className='flex items-center gap-2'>
              <Image src="/assets/calender.svg" alt="timer" width={20} height={1206} />
        ...
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_bybit-compitition2.webp" alt="_bybit-compitition2" className='rounded-2xl' width={155} height={155} loading='lazy' />
          <div className='mt-1 flex flex-col gap-1'>
            <p className='text-gray_500 text-[13px] leading-[20px] f-pretendard-m'>딥코인 신규회원 이벤트</p>
            <p className='text-gray_900 text-[17px] leading-[26px] f-pretendard-b'>입금하고 최대 1,000 USDT 받아가세요!</p>
            <div className='flex items-center gap-2'>
      ...
      <div className='bg-gray_55 pt-8 pb-[150px] px-5'>
        ...
        <p className="text-gray_300 text-[13px] mt-3 f-pretendard-sm" style={{ lineHeight: "150%" }}>
          테더맥스 계정으로 거래하는 수수료는 거래소의 최대 수수료에 일정 할인율을 적용한 수수료입니다. 바이비트 트레이딩을 통한 페이백은 매일 11:00 UTC시에 트레이더님의 테더맥스 계정으로 지급됩니다.<br />
