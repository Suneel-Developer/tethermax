...
const EventStep = () => {
  ...
  return (
    <section className='pt-7 md:pt-8 bg-white'>
      <div className='mx-5 f-pretendard-b text-gray_900 text-[22px] leading-[32px]'>현재 진행중인 BitMart 이벤트에요</div>
      ...
      <div className='mt-8 flex gap-4 px-5 overflow-x-auto no-scrollbar pb-14'>
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_bitmart-event.webp" alt="_bybit" className='rounded-2xl' width={155} height={155} loading='lazy' />
      ...
      <div className='mt-8 flex gap-4 px-5 overflow-x-auto no-scrollbar pb-14'>
        ...
        <div className='w-[155px] min-w-[155px] max-w-[155px]'>
          <Image src="/assets/_bitmart-event.webp" alt="_deepcoin" className='rounded-2xl' width={155} height={155} loading='lazy' />
          <div className='mt-1 flex flex-col gap-1'>
            <p className='text-gray_500 text-[13px] leading-[20px] f-pretendard-m'>딥코인 신규회원 이벤트</p>
            <p className='text-gray_900 text-[17px] leading-[26px] f-pretendard-b'>입금하고 최대 1,000 USDT 받아가세요!</p>
            <div className='flex items-center gap-2'>
      ...
      <div className='p-6 bg-white flex items-center justify-between cursor-pointer'>
        ...
        <Image src="/assets/right-arrow.svg" alt="right-arrow" width={20} height={20} />
      </div>
      ...
      <div className='bg-gray_55 pt-8 pb-[150px] px-5'>
        ...
        >
          BitMart과 테더맥스는 공식 제휴 관계입니다.<br />
          카피트레이딩 또는 API를 통해 거래하는 경우에도 동일한 페이백율이 적용됩니다.<br />
          BitMart의 페이백은 매일 11시(UTC) 에 트레이더님의 테더맥스 계정으로 지급됩니다.<br />
          나의 페이백 랭킹 이벤트는 BitMart의 경우 24년 07월 01일부터 최초 진행됩니다.<br />
